...
public class GraphicsToGraphics2DAdaptor extends Graphics {
     ...
     * Constructor
     *
     * @param graphics the <code>Graphics2D</code> object that this object is
     *                 delegating calls to.
     * @param viewPort the <code>Rectangle</code> that defines the logical area
     ...
     * @param graphics the <code>Graphics2D</code> object that this object is
     *                 delegating calls to.
     * @param viewPort the <code>org.eclipse.swt.graphics.Rectangle</code> that
