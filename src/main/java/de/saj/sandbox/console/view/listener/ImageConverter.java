...
public class ImageConverter {
     ...
     *
     * @param srcImage the {@link java.awt.image.BufferedImage} to be converted
     *                 to an <code>Image</code>
    ...
    public static Image convert(BufferedImage srcImage) {
        return new Image(null, convertToImageData(srcImage));
    }
     ...
     *
     * @param srcImage the {@link org.eclipse.swt.graphics.Image} to be
     *                 converted to a <code>BufferedImage</code>
     ...
     * image that is passed into the method.
     *
     * @param imageData the {@link org.eclipse.swt.graphics.Image} to be
     *                  converted to a <code>BufferedImage</code>
     * @return a <code>BufferedImage</code> that represents the same image data
     * as the swt <code>Image</code>
     * @since 1.3.1
